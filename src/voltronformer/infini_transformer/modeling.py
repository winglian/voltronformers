...
# constants
from src.voltronformer.bitlinear import BitLinear
...
class FeedForward(Module):
    def __init__(
        ...
        self.proj_out = BitLinear(dim_inner, dim)
...
class CausalAttention(Module):
    def __init__(
        ...
        self.to_qkv = BitLinear(dim, dim_inner * 3, bias = False)
        self.to_out = BitLinear(dim_inner, dim, bias = False)
